...
--TRAJECTORY_BUILDER_2D.motion_filtermax_time_seconds = 5.,
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution=0.05--0.05

--TRAJECTORY_BUILDER_2D.submaps.num_range_data = 90
--TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.hit_probability=0.51 --0.55
